...
class _ListPasienState extends State<ListPasien> {
  ...
  _downloadData(List<UserModel> data) async {
          ...
          return pw.Container(
            ...
            child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text("Tgl Laporan : ${DateTime.now().toString()}"),
                  pw.SizedBox(
                    height: 25,
                  ),
                  pw.Text('Laporan User', style: pw.Theme.of(context).header3),
                ]),
          );
        },
    ...
    final file =
        File("$appDocPath/laporan_pasien_${DateTime.now().toString()}.pdf");
